...
import 'package:handcraft_reservation/core/email/sender.dart';
...
class BookingForm extends ConsumerStatefulWidget {
  ...
  const BookingForm({super.key, required this.city, required this.date, required this.slot, required this.pax});
@override
