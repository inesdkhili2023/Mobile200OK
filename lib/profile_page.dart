...
// Add these imports - you'll need to create these files or adjust the paths
// import 'screens/my_services_screen.dart';
// import 'screens/become_worker_screen.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  // Remove the duplicate _buildAccountOption methods and keep only one
    ...
    return Card(
      ...
      child: ListTile(
        leading: Container(
          ...
          child: Icon(icon, color: const Color.fromARGB(255, 0, 66, 208)),
        ),
        title: Text(
          title,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Section conditionnelle pour les boutons "My Services" et "Become a Worker"
                  if (user.role.toLowerCase() == 'employe' ||
                      user.role.toLowerCase() == 'employé') ...[
                    _buildAccountOption(
                      icon: Icons.work_outline,
                      title: 'My Services',
                      subtitle: 'See your Services',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
    ...
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        ...
        style: OutlinedButton.styleFrom(
          foregroundColor: const Color.fromARGB(255, 0, 66, 208),
          side: const BorderSide(
              color: Color.fromARGB(255, 0, 66, 208), width: 2),
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12),
          ),
        ),
