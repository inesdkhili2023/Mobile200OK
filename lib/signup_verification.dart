...
class _SignupVerificationPageState extends State<SignupVerificationPage> {
  ...
  Future<void> _verifyCode(BuildContext context) async {
    ...
    final isValid = await _authService.verifySignupCode(code);
    ...
    if (isValid) {
      // Complete the signup
      final success = await _authService.completeSignup();
  ...
  Future<void> _resendCode(BuildContext context) async {
    ...
    final result = await _authService.resendSignupVerificationCode();
